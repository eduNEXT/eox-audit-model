...
## [v6.2.0](https://github.com/eduNEXT/eox-audit-model/compare/v6.1.0...v6.2.0) - (2026-06-26)

### Changed

- **Verawood  Support**: Upgrade requirements base on edx-platform Verawood
release, update GitHub Workflows with new actions version.

## [v6.1.0](https://github.com/eduNEXT/eox-audit-model/compare/v6.0.0...v6.1.0) - (2025-10-13)
...
- **Teak Support**: Upgrade requirements base on the edx-platform Teak release
...
- **Sumac Support**: Upgrade requirements base on the edx-platform Sumac
  release, update GitHub workflows and actions version.
...
## [v4.2.0](https://github.com/eduNEXT/eox-audit-model/compare/v4.1.0...v4.2.0) - (2024-06-19)
